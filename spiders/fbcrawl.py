...
class FacebookSpider(scrapy.Spider):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # self.cookies = {
        #     'xs': '17%3AeX6QBB9Nppp-Dw%3A2%3A1577582698%3A14669%3A10457',
        #     'c_user': '100041098163672',
        #     'datr': '0jPpXYdxqZ3HsIy6HSTyLr4R',
        #     'fr': '17FpuhahkZXlFcs3N.AWVx-gLkZz9LXmarfAIj0Z6f_hQ.Bd6TPS.um.F4I.0.0.BeCACU.AWWj9Kzo'
        # }
        self.cookies = {
            'xs': '14%3AYLTyVvY0ybaYfQ%3A2%3A1576779892%3A10144%3A6277',
            'c_user': '100041525880686',
            'datr': 'l1HpXXjERM-Fjm8IjoTEWz42',
            'fr': '1cmbdTq9xE2xCdwC7.AWWwXEQHF143kMEZLXwn6NVGNe0.Bd6VGX.WT.F3_.0.0.BeEj1X.AWU532Mz'
        }
            ...
            if response.meta['flag'] == self.k and self.k >= self.year:
                ...
                if new_page:
                    ...
                    while not new_page:  # sometimes the years are skipped this handles small year gaps
                        self.logger.info(
                            'Link not found for year {}, trying with previous year {}'.format(self.k, self.k - 1))
                        self.k -= 1
                        if self.k < self.year:
